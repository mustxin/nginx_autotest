"""
proxy_set_header模块测试脚本
负责执行proxy_set_header模块的测试用例
"""
...
# 读取测试数据
test_data = read_yaml(get_test_data_path("proxy_set_header.yaml"))
...
def test_proxy_set_header(case_id, case_info):
    """
